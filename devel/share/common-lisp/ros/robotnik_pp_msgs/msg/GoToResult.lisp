...
(cl:defmethod cl:initialize-instance :after ((m <GoToResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoToResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_pp_msgs-msg:<GoToResult> is deprecated: use robotnik_pp_msgs-msg:GoToResult instead.")))

(cl:ensure-generic-function 'route_result-val :lambda-list '(m))
(cl:defmethod route_result-val ((m <GoToResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_pp_msgs-msg:route_result-val is deprecated.  Use robotnik_pp_msgs-msg:route_result instead.")
  (route_result m))
