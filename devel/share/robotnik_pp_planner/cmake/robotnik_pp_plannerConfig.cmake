...
if(robotnik_pp_planner_CONFIG_INCLUDED)
  return()
endif()
set(robotnik_pp_planner_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(robotnik_pp_planner_SOURCE_PREFIX /home/punnu/catkin_ws/src/robotnik_purepursuit_planner/robotnik_pp_planner)
  set(robotnik_pp_planner_DEVEL_PREFIX /home/punnu/catkin_ws/devel)
  set(robotnik_pp_planner_INSTALL_PREFIX "")
  set(robotnik_pp_planner_PREFIX ${robotnik_pp_planner_DEVEL_PREFIX})
else()
  set(robotnik_pp_planner_SOURCE_PREFIX "")
  set(robotnik_pp_planner_DEVEL_PREFIX "")
  set(robotnik_pp_planner_INSTALL_PREFIX /home/punnu/catkin_ws/install)
  set(robotnik_pp_planner_PREFIX ${robotnik_pp_planner_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'robotnik_pp_planner' is deprecated")
...
set(robotnik_pp_planner_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/punnu/catkin_ws/src/robotnik_purepursuit_planner/robotnik_pp_planner/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/include/libxml2;/usr/include/x86_64-linux-gnu;/usr/include/tcl;/usr/include/python2.7 " STREQUAL " ")
  set(robotnik_pp_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/punnu/catkin_ws/src/robotnik_purepursuit_planner/robotnik_pp_planner/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/include/libxml2;/usr/include/x86_64-linux-gnu;/usr/include/tcl;/usr/include/python2.7")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${robotnik_pp_planner_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robotnik_pp_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'robotnik_pp_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/punnu/catkin_ws/src/robotnik_purepursuit_planner/robotnik_pp_planner/${idir}'.  ${_report}")
    endif()
    _list_append_unique(robotnik_pp_planner_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND robotnik_pp_planner_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/punnu/catkin_ws/devel/lib;/home/punnu/catkin_ws/devel/lib;/home/punnu/Autoware/ros/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(robotnik_pp_planner_LIBRARY_DIRS ${lib_path})
      list(APPEND robotnik_pp_planner_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'robotnik_pp_planner'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND robotnik_pp_planner_LIBRARIES ${lib})
    endif()
  endif()
...
set(robotnik_pp_planner_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${robotnik_pp_planner_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;actionlib;nav_msgs;roscpp;std_msgs;tf;geometry_msgs;robotnik_pp_msgs;ackermann_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 robotnik_pp_planner_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${robotnik_pp_planner_dep}_FOUND)
      find_package(${robotnik_pp_planner_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robotnik_pp_planner_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(robotnik_pp_planner_INCLUDE_DIRS ${${robotnik_pp_planner_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(robotnik_pp_planner_LIBRARIES ${robotnik_pp_planner_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${robotnik_pp_planner_dep}_LIBRARIES})
  _list_append_deduplicate(robotnik_pp_planner_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(robotnik_pp_planner_LIBRARIES ${robotnik_pp_planner_LIBRARIES})

  _list_append_unique(robotnik_pp_planner_LIBRARY_DIRS ${${robotnik_pp_planner_dep}_LIBRARY_DIRS})
  list(APPEND robotnik_pp_planner_EXPORTED_TARGETS ${${robotnik_pp_planner_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${robotnik_pp_planner_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
