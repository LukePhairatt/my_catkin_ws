...
"""autogenerated by genpy from nodelet_rosbag/RecordActionResult.msg. Do not edit."""
import sys
...
class RecordActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "nodelet_rosbag/RecordActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nodelet_rosbag/RecordResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecordActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = nodelet_rosbag.msg.RecordResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nodelet_rosbag.msg.RecordResult()
