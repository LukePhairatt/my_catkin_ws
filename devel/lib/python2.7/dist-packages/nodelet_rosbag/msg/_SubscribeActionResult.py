...
"""autogenerated by genpy from nodelet_rosbag/SubscribeActionResult.msg. Do not edit."""
import sys
...
class SubscribeActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "nodelet_rosbag/SubscribeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nodelet_rosbag/SubscribeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SubscribeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = nodelet_rosbag.msg.SubscribeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nodelet_rosbag.msg.SubscribeResult()
