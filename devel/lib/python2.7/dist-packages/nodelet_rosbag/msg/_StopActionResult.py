...
"""autogenerated by genpy from nodelet_rosbag/StopActionResult.msg. Do not edit."""
import sys
...
class StopActionResult(genpy.Message):
  ...
  _type = "nodelet_rosbag/StopActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nodelet_rosbag/StopResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = nodelet_rosbag.msg.StopResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nodelet_rosbag.msg.StopResult()
