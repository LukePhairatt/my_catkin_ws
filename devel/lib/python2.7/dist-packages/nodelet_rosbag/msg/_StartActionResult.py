...
"""autogenerated by genpy from nodelet_rosbag/StartActionResult.msg. Do not edit."""
import sys
...
class StartActionResult(genpy.Message):
  ...
  _type = "nodelet_rosbag/StartActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nodelet_rosbag/StartResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = nodelet_rosbag.msg.StartResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nodelet_rosbag.msg.StartResult()
