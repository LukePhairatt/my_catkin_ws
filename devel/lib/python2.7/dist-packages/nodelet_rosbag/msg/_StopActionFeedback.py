...
"""autogenerated by genpy from nodelet_rosbag/StopActionFeedback.msg. Do not edit."""
import sys
...
class StopActionFeedback(genpy.Message):
  ...
  _type = "nodelet_rosbag/StopActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nodelet_rosbag/StopFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = nodelet_rosbag.msg.StopFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = nodelet_rosbag.msg.StopFeedback()
