...
#include "../../../../../src/rqt_mypkg/rqt_example_cpp/include/rqt_example_cpp/my_plugin.h"
...
struct qt_meta_stringdata_rqt_example_cpp__MyPlugin_t {
    QByteArrayData data[1];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rqt_example_cpp__MyPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rqt_example_cpp__MyPlugin_t qt_meta_stringdata_rqt_example_cpp__MyPlugin = {
    {
QT_MOC_LITERAL(0, 0, 25) // "rqt_example_cpp::MyPlugin"

    },
    "rqt_example_cpp::MyPlugin"
};
...
const QMetaObject rqt_example_cpp::MyPlugin::staticMetaObject = {
    { &rqt_gui_cpp::Plugin::staticMetaObject, qt_meta_stringdata_rqt_example_cpp__MyPlugin.data,
      qt_meta_data_rqt_example_cpp__MyPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *rqt_example_cpp::MyPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rqt_example_cpp__MyPlugin.stringdata0))
